...
LawyersService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(lawyer_repository_1.LawyerRepository)),
    __metadata("design:paramtypes", [lawyer_repository_1.LawyerRepository])
], LawyersService);
